...
export const metadata: Metadata = {
  title: "NOvella - Premium Automotive Excellence",
  description: "Discover NOvella vehicles featuring elegant design, intelligent technology, and exceptional performance. Premium cars for the modern road.",
  keywords: "luxury cars, premium vehicles, automotive innovation, electric vehicles, sedan, SUV",
  metadataBase: new URL("https://novella.com"),
  alternates: {
    canonical: "https://novella.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "NOvella - Drive the Future",
    description: "Experience premium automotive excellence with NOvella. Elegant design, intelligent technology, built for the modern road.",
    type: "website",
    siteName: "NOvella",
    url: "https://novella.com",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363fycCW5gR5mBuwyI3Zdk1DwTq/uploaded-1765797335764-a67x20g4.jpg",
      alt: "NOvella luxury vehicle showcase"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "NOvella - Premium Vehicles",
    description: "Drive the future with NOvella. Elegant design and intelligent technology.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363fycCW5gR5mBuwyI3Zdk1DwTq/uploaded-1765797335764-a67x20g4.jpg"]
  }
};
